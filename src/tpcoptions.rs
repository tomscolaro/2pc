...
impl TPCOptions {
    ...
    pub fn new() -> TPCOptions {
        ...
        let default_ipc_path2 = "none";
        let default_num = "0";

        // Set-Up clap
        let matches = App::new("concurrency-2pc")
            .version("0.1.0")
            .author("Thomas Scolaro <tscolaro@utexas.edu>")
        ...
        let ipc_path2 = matches.value_of("ipc_path2").unwrap_or(default_ipc_path2);
    ...
    pub fn as_vec(&self) -> Vec<String> {
        vec![
            ...
            format!("--ipc_path2={}", self.ipc_path2),
            format!("--num={}", self.num),
        ]
    }
}
